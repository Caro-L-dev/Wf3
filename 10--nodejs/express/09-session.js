...
//1- créons ensemble un compteur de visite qui va nous permettre de compter ne nb de visites sur notre page.
...
app.get('/', (req, res) =>{
    ...
    /**
     * A présent nous avons bien un compteur, mais il est global:
     * Lorsque nous changeons de navigateur, le compte ne s'arrête pas.
     * alors que nous venons d'arriver sur la page.
     * Pour resoudre ce problème, nous allons faire un compteur personnalisé pour chaque utilisateur.
     */
})
